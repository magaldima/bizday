...
type DateCalcClient interface {
	...
	DaysBetween(ctx context.Context, in *BinaryDateRequest, opts ...grpc.CallOption) (*NumberOfDaysResponse, error)
	// CalendarDaysBetween calculates the number of days between two dates using the calendar, not the day count basis.
	CalendarDaysBetween(ctx context.Context, in *BinaryDateRequest, opts ...grpc.CallOption) (*NumberOfDaysResponse, error)
...
func (c *dateCalcClient) DaysBetween(ctx context.Context, in *BinaryDateRequest, opts ...grpc.CallOption) (*NumberOfDaysResponse, error) {
	out := new(NumberOfDaysResponse)
	err := grpc.Invoke(ctx, "/github.com.magaldima.bizday.api.DateCalc/DaysBetween", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dateCalcClient) CalendarDaysBetween(ctx context.Context, in *BinaryDateRequest, opts ...grpc.CallOption) (*NumberOfDaysResponse, error) {
	out := new(NumberOfDaysResponse)
	err := grpc.Invoke(ctx, "/github.com.magaldima.bizday.api.DateCalc/CalendarDaysBetween", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DateCalcServer interface {
	// DaysBetween calculates the number of days between two dates using the proper day count basis (DCB)
	DaysBetween(context.Context, *BinaryDateRequest) (*NumberOfDaysResponse, error)
	// CalendarDaysBetween calculates the number of days between two dates using the calendar, not the day count basis.
	CalendarDaysBetween(context.Context, *BinaryDateRequest) (*NumberOfDaysResponse, error)
	// Calculates the number of business days between two dates.
	// This operates like array operations and is inclusive of the start and exclusive of the end.
...
func _DateCalc_DaysBetween_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BinaryDateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DateCalcServer).DaysBetween(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/github.com.magaldima.bizday.api.DateCalc/DaysBetween",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DateCalcServer).DaysBetween(ctx, req.(*BinaryDateRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _DateCalc_CalendarDaysBetween_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BinaryDateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DateCalcServer).CalendarDaysBetween(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/github.com.magaldima.bizday.api.DateCalc/CalendarDaysBetween",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DateCalcServer).CalendarDaysBetween(ctx, req.(*BinaryDateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _DateCalc_DaysBetween_Handler,
		},
		{
			MethodName: "CalendarDaysBetween",
			Handler:    _DateCalc_CalendarDaysBetween_Handler,
		},
		{
...
var fileDescriptor0 = []byte{
	...
	,
}
